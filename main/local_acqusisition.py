...
@date: 2022-04-3
@version: 1.4
@brief: Local acquisition graphene sensor data and show on display, without upload to firebase
"""
...
def cfg_read_task(acquisition):  # uses above parameters
    acquisition.ai_channels.add_ai_voltage_chan("cDAQ2Mod1/ai0:2")  # has to match with chans_in
