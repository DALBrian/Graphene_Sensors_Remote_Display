...
@date: 2022-04-2
@version: 1.4.1
@brief: Acquisition graphene sensor data and show on display, also upload to firebase
"""
...
class Firebase():
    def __init__(self,JSONlocation ,DBfolder = 'DAQSet'):
        ...
        # Remove credential information from the repository
        db_config = {
          "apiKey": "XXX",
...
import csv
with open('Fast_UploadTime.csv', 'w', newline='') as csvfile:
  # 建立 CSV 檔寫入器
  writer = csv.writer(csvfile)
  writer.writerow(ULTime)